<%-- 
    Document   : endereco
    Created on : 27/01/2021, 21:23:52
    Author     : Alexandre
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            function pegarsigla() {
                ...
                document.getElementById('sigla_hidden').value = sigla;
            }
            function pegarcomplemento() {
                var complemento = document.getElementById('complemento').value;
                document.getElementById('complemento_hidden').value = complemento;
            }
        </script>
    </head>
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="UpdateEndereco" method="POST">
