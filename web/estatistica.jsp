<%-- 
    Document   : dashboard
    Created on : 27/01/2021, 16:05:10
    Author     : Alexandre
--%>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <div class="d-md-flex">
                                ...
                                <a href="../SairServlet" target="_self"
                                   class="btn btn-danger  d-none d-md-block pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Sair</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.col-lg-12 -->
                                ...
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    <li>
                                        <div id="sparklinedash2"><canvas width="67" height="30"
                                                                         style="display: inline-block; width: 67px; height: 50px; vertical-align: top;"></canvas>
                                        </div>
                                    </li>
