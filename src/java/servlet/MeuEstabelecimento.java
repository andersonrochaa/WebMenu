 ...
 * @author Alexandre
 */
public class MeuEstabelecimento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("nome", est.getNome());
        request.setAttribute("email", est.getEmail());
        request.setAttribute("descricao", est.getDescricao());
        request.setAttribute("telefone", est.getTelefone());
        request.setAttribute("imagem", est.getImagem());
